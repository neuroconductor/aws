...
This document illustrates the capabilities of the \pkg{aws}. For a more comprehensive overview and
...
The code in this vignette is restricted to 1D and 2D examples due to limit computation time.
