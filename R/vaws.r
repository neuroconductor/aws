...
#     default parameters:  
#       
#             uni:         heta=10  qtau=.92   qlambda=.966
#             bi:          heta=2   qtau=.92   qlambda=.966
#             tri:         heta=2   qtau=.92   qlambda=.966
#
#
vaws <- function(y,qlambda=NULL,lkern="Triangle",sigma2=NULL,shape=NULL,
...
###            end cases                                                  
###                                                                       
z<-list(theta=tobj$theta,ni=tobj$bi,y=y,call=args)
