...
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine awsp1(y,fix,nfix,n,degr,hw,hakt,hhom,lambda,theta,
...
C
     ...
     1       bi2(1),hakt,lw(1),w(1),hw,sw(1),slw(1),hhom(n,2)
      integer ih,k,iind,jind,dlw,clw,jw1,
     ...
     2       hhommax,hhommin,az1,hfixmax,hnfix,
     3       hhomimin,hhomimax
...
C   compute location weights first
      DO jind=1,dlw
         z1=clw-jind
         lw(jind)=lkern(kern,z1*z1/hakt2)
      END DO
      cc=0.0d0
...
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine awsp1p(y,fix,nfix,n,degr,hw,hakt,hhom,lambda,theta,
     1        bi,bi2,bi0,ai,kern,spmin,lw,slw,ind)
C   
C   y        observed values of regression function
C   fix      logical TRUE fro points where we have nothing to do
C   n1,n2    design dimensions
...
C
      ...
      logical aws,fix(1),lfix
      real*8 y(1),theta(1),bi(1),bi0(1),ai(1),lambda,spmin,
     1       bi2(1),hakt,lw(1),hw,slw(1),hhom(n,2)
      integer ih,k,iind,jind,dlw,clw,jw1,
     2        dp1,dp2,ihs,csw,dsw,l
      real*8 bii(5),sij,swj(5),swj2(5),swj0(5),swjy(5),z1,wj,wj2,
     1       hakt2,thij(3),thi(3),zz(5),lwj,yj,hs2,hs,z,cc,spf,
     2       hhommax,hhommin,az1,hfixmax,hnfix,
     3       hhomimin,hhomimax,w(1999),sw(2009)
C   arrays with variable length are organized as 
C   theta(n,dp1)
C   bi(n,dp2)
C   arrays of fixed length correspond to degr=2
...
C$OMP& PRIVATE(iind,hhomimin,hhomimax,hhommin,hhommax,hfixmax,k,
C$OMP&         jw1,jind,wj,z1,az1,sij,z,cc,lwj,wj2,yj,
...
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine awsp1p0(y,fix,nfix,n,degr,hw,hakt,hhom,lambda,theta,
     1        bi,bi2,bi0,ai,kern,spmin,lw,slw,ind)
C   
C   y        observed values of regression function
C   fix      logical TRUE fro points where we have nothing to do
...
C
     ...
     2        dp1,dp2,ihs,csw,dsw,l,iindl,jindl
      real*8 bii(5),sij,swj(5),swj2(5),swj0(5),swjy(5),z1,wj,wj2,
     1       hakt2,thij(3),thi(3),zz(5),lwj,yj,hs2,hs,z,cc,spf,
     2       hhommax,hhommin,az1,hfixmax,hnfix,spmax,
     3       hhomimin,hhomimax,w(1999),sw(2009)
C   arrays with variable length are organized as 
C   theta(n,dp1)
C   bi(n,dp2)
...
C$OMP PARALLEL DEFAULT(SHARED) 
C$OMP& PRIVATE(iind,hhomimin,hhomimax,hhommin,hhommax,hfixmax,k,
C$OMP&         jw1,j1,jind,jindl,iindl,wj,z1,
C$OMP&         az1,sij,z,cc,lwj,wj2,yj,
C$OMP&         zz,w,sw,bii,thi,thij,swj,swj2,swj0,swjy)
C$OMP DO SCHEDULE(DYNAMIC,1)
      DO iind=1,n
         IF (fix(iind)) CYCLE
...
C
     ...
     2        dp1,dp2,ihs,csw,dsw,l,dlw2,iindl
      real*8 bii(15),sij,swj(15),swj2(15),swj0(15),swjy(6),z1,z2,wj,
     1       hakt2,thij(6),thi(6),zz(15),lwj,hs2,hs,z,cc,wjy,spf,hhomi,
     2       hhommax,az1,hfixmax,hnfix,wj2,w(1521),sw(1849)
