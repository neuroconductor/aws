...
C
     ...
     1       bi2(1),hakt,lw(1),w(1),hw,sw(1),slw(1),hhom(n,2)
      integer ih,k,iind,jind,dlw,clw,jw1,dp1,dp2,ihs,csw,dsw
...
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine awsph1p(y,si,fix,nfix,n,degr,hw,hakt,hhom,lambda,
...
C  now stochastic term
C$OMP PARALLEL DEFAULT(SHARED) 
C$OMP& PRIVATE(iind,hhomi,hhommax,hfixmax,k,iindl,jindl,
C$OMP&         jw1,jind,wj,z1,az1,sij,z,cc,lwj,wj2,yj,
C$OMP&         zz,w,sw,bii,thi,thij,swj,swj2,swj0,swjy)
C$OMP DO SCHEDULE(DYNAMIC,1)
      DO iind=1,n
...
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine awsph2p(y,si,fix,nfix,n1,n2,degr,hw,hakt,hhom,lambda,
     1              theta,bi,bi2,bi0,ai,kern,spmin,lw,slw,ind)
C
C   y        observed values of regression function
C   fix      logical TRUE fro points where we have nothing to do
