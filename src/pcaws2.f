...
C
C   Patch based aws
C   Variante 2 with weighted sum of sij over patches
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine pcaws2(y,n1,n2,n3,hakt,lambda,theta,bi,bip,bi2,
...
C$OMP& jp1,jp2,jp3,jpind,swp,biip)
...
C
C   Patch based aws
C   Variante 3 using quantiles of sij over patches
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine pcaws3(y,n1,n2,n3,hakt,lambda,theta,bi,bi2,
     1                bi0,bin,ai,model,kern,spmin,lwght,wght,npsize,
     2                qind)
C
C   y        observed values of regression function
...
C
      ...
      external kldist,lkern
      double precision kldist,lkern
      integer n1,n2,n3,model,kern,npsize,qind
      logical aws
      double precision y(*),theta(*),bi(*),bi0(*),ai(*),lambda,wght(2),
     1       bi2(*),bin(*),hakt,lwght(*),spmin,spf,psij(125)
      integer ih1,ih2,ih3,i1,i2,i3,j1,j2,j3,jw1,jw2,jw3,jwind3,jwind2,
     1        iind,jind,jind3,jind2,clw1,clw2,clw3,dlw1,dlw2,dlw3,
...
C$OMP& swj0,swjy,sij,wj,j3,jw3,jind3,z3,jwind3,j2,jw2,jind2,z2,jwind2,
C$OMP& j1,jw1,jind,z1,ip1,ip2,ip3,ipind,
C$OMP& jp1,jp2,jp3,jpind,biip,pcj,psij)
C$OMP DO SCHEDULE(GUIDED)
      DO iind=1,n1*n2*n3
          i1=mod(iind,n1)
          if(i1.eq.0) i1=n1
                  ...
                  DO ip1=i1-nph1,i1+nph1
                      ...
                      DO ip2=i2-nph2,i2+nph2
                        ...
                        DO ip3=i3-nph3,i3+nph3
                            ...
                            psij(pcj)= bi(ipind)*
     1                kldist(model,theta(ipind),theta(jpind))
      if(ip1.eq.i1.and.ip2.eq.i2.and.ip3.eq.ip3) sij=psij(pcj)
                        END DO
                      END DO
                  END DO
                  call qsort3(psij,1,pcj)
                  if(qind.le.pcj) THEN
                      sij=max(psij(qind),sij)/lambda
                  ELSE
                      sij= psij(pcj)/lambda
                  ENDIF
                  IF(sij.gt.1.d0) CYCLE
...
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine pcawsm2(y,pos,n1,n2,n3,hakt,lambda,theta,bi,bi2,
...
C$OMP& j1,jw1,jind,z1,thrednr,ip1,ip2,ip3,pc,
