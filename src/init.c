...
void F77_NAME(pvaws2b)(double* y, int* pos, int* nv, int* nvd,
	int* n1, int* n2, int* n3, double* hakt, double* lambda,
	double* theta, double* bi, double*bin, double* thnew, double* invcov,
	int* ncores, double* spmin, double* lwght, double* wght,
	double* swjy, int* np1, int* np2, int* np3, int* nmask, int* nvoxel, int* nsupp);
...
static R_NativePrimitiveArgType pvaws2b_t[]={REALSXP, INTSXP, INTSXP, INTSXP,
	INTSXP, INTSXP, INTSXP, REALSXP, REALSXP, REALSXP, REALSXP, REALSXP, REALSXP, REALSXP,
	INTSXP, REALSXP, REALSXP, REALSXP, REALSXP, INTSXP, INTSXP, INTSXP, INTSXP, INTSXP, INTSXP};
...
static const R_FortranMethodDef fmethods[] = {
            ...
            {"pvaws2", (DL_FUNC) &pvaws2_ ,22, pvaws2_t},
						{"pvaws2b", (DL_FUNC) &pvaws2b_ ,25, pvaws2b_t},
